...
function Write-Theme {
    ...
    if (Test-VirtualEnv) {
        ...
        $prompt += Write-Prompt -Object "$($sl.PromptSymbols.SegmentForwardSymbol) " -ForegroundColor $sl.Colors.UserBackgroundColor -BackgroundColor $sl.Colors.VirtualEnvBackgroundColor
